    ...
    stages {
        ...
        stage("Install Liquibase") {
            ...
            steps {
                ...
                sh('mkdir ${LIQUIBASE_HOME} && cd ${LIQUIBASE_HOME} && wget -qO- https://github.com/liquibase/liquibase/releases/download/v{LIQUIBASE_VERSION}/liquibase-{LIQUIBASE_VERSION}.tar.gz | tar xz')
